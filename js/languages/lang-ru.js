// verson translation 0.3.1 patch 1 for SI:NGR
LANGUAGES.RU = {
    name: "Russian",
    inter_name: "Русский",
    icon: "lang-ru",
    ...
    text: {
        ...
        get 'singularity-milestones'() {
            return [
                ...
                [`${format(1e12)} Всего Темной Материи`,`Открывает новую функцию ${toTextStyle("Сингулярности",'black-hole')} - <b>Элементы</b>.`],
            ]
        },
        ...
        'remnant-upgrades': [
            ...
            [`Множитель Кварков`,x=>`Умножает количество Кварков в ${x}.`],
        ],
